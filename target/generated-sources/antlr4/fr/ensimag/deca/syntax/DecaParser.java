...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		PLUS=25, MINUS=26, TIMES=27, SLASH=28, PERCENT=29, EXCLAM=30, READINT=31, 
		READFLOAT=32, NEW=33, EOL=34, ESPACE=35, INT=36, FLOAT=37, DOT=38, STRING=39, 
		MULTI_LINE_STRING=40, TRUE=41, FALSE=42, THIS=43, NULL=44, CLASS=45, EXTENDS=46, 
		PROTECTED=47, PUBLIC=48, ASM=49, INCLUDE=50, IDENT=51, WS=52, COMMENT=53;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MINUS", "TIMES", "SLASH", "PERCENT", "EXCLAM", "READINT", "READFLOAT", 
			"NEW", "EOL", "ESPACE", "INT", "FLOAT", "DOT", "STRING", "MULTI_LINE_STRING", 
	...
	public final Decl_varContext decl_var(AbstractIdentifier t) throws RecognitionException {
		...
		try {
			...
			((Decl_varContext)_localctx).i = ident();
			            ...
			            ((Decl_varContext)_localctx).tree =  new DeclVar(_localctx.t,((Decl_varContext)_localctx).i.tree, init1);
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2285557250031440L) != 0)) {
				{
				{
				setState(124);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					        ...
					        elseIf = new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).elsif_li.tree, thenBranch);
					        setLocation(elseIf, ((If_then_elseContext)_localctx).elsif);
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2285557249998912L) != 0)) {
				{
				setState(216);
					...
					case 2:
						{
						                      ...
						                      ((Select_exprContext)_localctx).tree =  new Selection(((Select_exprContext)_localctx).i.tree, ((Select_exprContext)_localctx).e1.tree);
		...
		try {
			...
			case FLOAT:
				...
				((LiteralContext)_localctx).fd = match(FLOAT);
				        ...
				        String text = (((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getText():null);
				    // je voulez traité le cas des float long 
				        if (text.startsWith("0x") || text.startsWith("0X")) { // en hexa
				            if(text.contains(".")) // qui contient un virgule
				            {
				                ...
				                ((LiteralContext)_localctx).tree =  new FloatLiteral((float) Double.parseDouble(text));
				                
				            } else {((LiteralContext)_localctx).tree =  new FloatLiteral((float) Long.parseLong((((LiteralContext)_localctx).fd!=null?((LiteralContext)_localctx).fd.getText():null).substring(2), 16));
				            }
			...
			case STRING:
				...
				((LiteralContext)_localctx).STRING = match(STRING);
				        ...
				        // on supprime les " au debut et la fin et on remplace les \" par " et \\ par \
				            ((LiteralContext)_localctx).tree =  new StringLiteral((((LiteralContext)_localctx).STRING!=null?((LiteralContext)_localctx).STRING.getText():null).substring(1, (((LiteralContext)_localctx).STRING!=null?((LiteralContext)_localctx).STRING.getText():null).length() - 1).replaceAll("\\\\\"" , "\"").replaceAll("\\\\\\\\", "\\\\"));
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			...
			((IdentContext)_localctx).IDENT = match(IDENT);
			        ...
			        compiler.symbolTable.create((((IdentContext)_localctx).IDENT!=null?((IdentContext)_localctx).IDENT.getText():null));
			        ((IdentContext)_localctx).tree =  new Identifier(compiler.symbolTable.getSymbole((((IdentContext)_localctx).IDENT!=null?((IdentContext)_localctx).IDENT.getText():null)));
	...
	public final Class_declContext class_decl() throws RecognitionException {
		...
		try {
			...
			match(CBRACE);
			        ...
			        ((Class_declContext)_localctx).tree =  new DeclClass(((Class_declContext)_localctx).name.tree, ((Class_declContext)_localctx).superclass.tree, ((Class_declContext)_localctx).class_body.champs ,((Class_declContext)_localctx).class_body.method);
		...
		try {
			...
			case OBRACE:
				enterOuterAlt(_localctx, 2);
				{
				        ...
				        DecacCompiler compiler = super.getDecacCompiler();
				        ((Class_extensionContext)_localctx).tree =  new Identifier(compiler.symbolTable.getSymbole("Object"));
	...
	public static class Class_bodyContext extends ParserRuleContext {
		public ListDeclField champs;
		public ListDeclMethod method;
	...
	public final Class_bodyContext class_body() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_class_body);
		    ...
		    ((Class_bodyContext)_localctx).champs =  new ListDeclField();
		    ((Class_bodyContext)_localctx).method =  new ListDeclMethod();
			...
			while (_la==PROTECTED || _la==IDENT) {
				...
				case 1:
					...
					((Class_bodyContext)_localctx).m = decl_method();
					        ...
					        _localctx.method.add(((Class_bodyContext)_localctx).m.tree);
				...
				case 2:
					{
					setState(488);
					decl_field_set(_localctx.champs);
					}
					break;
				}
				}
	...
	public final Decl_field_setContext decl_field_set(ListDeclField l) throws RecognitionException {
		...
		try {
			...
			setState(496);
			list_decl_field(((Decl_field_setContext)_localctx).v.tree, ((Decl_field_setContext)_localctx).t.tree, _localctx.l);
			setState(497);
			match(SEMI);
			}
		}
	...
	public static class List_decl_fieldContext extends ParserRuleContext {
		...
		public List_decl_fieldContext(ParserRuleContext parent, int invokingState, Visibility vis, AbstractIdentifier typ, ListDeclField l) {
			super(parent, invokingState);
			this.vis = vis;
			this.typ = typ;
			this.l = l;
	...
	public final List_decl_fieldContext list_decl_field(Visibility vis,AbstractIdentifier typ,ListDeclField l) throws RecognitionException {
		List_decl_fieldContext _localctx = new List_decl_fieldContext(_ctx, getState(), vis, typ, l);
		...
		try {
			...
			{
			setState(504);
			((List_decl_fieldContext)_localctx).dv1 = decl_field(_localctx.vis, _localctx.typ);
			...
			while (_la==COMMA) {
				...
				match(COMMA);
				setState(507);
				((List_decl_fieldContext)_localctx).dv2 = decl_field(_localctx.vis, _localctx.typ);
	...
	public static class Decl_fieldContext extends ParserRuleContext {
		...
		public Decl_fieldContext(ParserRuleContext parent, int invokingState, Visibility vis, AbstractIdentifier typ) {
			super(parent, invokingState);
			this.vis = vis;
			this.typ = typ;
		}
	...
	public final Decl_fieldContext decl_field(Visibility vis,AbstractIdentifier typ) throws RecognitionException {
		Decl_fieldContext _localctx = new Decl_fieldContext(_ctx, getState(), vis, typ);
		...
		try {
			...
			((Decl_fieldContext)_localctx).i = ident();
			            ...
			            ((Decl_fieldContext)_localctx).tree =  new DeclField(_localctx.vis, _localctx.typ, ((Decl_fieldContext)_localctx).i.tree, init1);
			...
			if (_la==EQUALS) {
				...
				((Decl_fieldContext)_localctx).e = expr();
				            ...
				            ((Decl_fieldContext)_localctx).tree =  new DeclField(_localctx.vis, _localctx.typ, ((Decl_fieldContext)_localctx).i.tree, init);
				            assert(_localctx.tree != null);
				            setLocation(init, ((Decl_fieldContext)_localctx).EQUALS);
		...
		try {
			...
			case ASM:
				...
				match(SEMI);
				        ...
				        StringLiteral string = new StringLiteral(((Decl_methodContext)_localctx).code.text.substring(1, ((Decl_methodContext)_localctx).code.text.length() - 1).replaceAll("\\\\\"" , "\"").replaceAll("\\\\\\\\", "\\\\"));
				        MethodAsmBody asmBody = new MethodAsmBody(string);
				        assert(asmBody != null);

				        ((Decl_methodContext)_localctx).tree =  new DeclMethod(((Decl_methodContext)_localctx).type.tree, ((Decl_methodContext)_localctx).ident.tree, ((Decl_methodContext)_localctx).params.tree, asmBody);
				        setLocation(asmBody, ((Decl_methodContext)_localctx).ASM);
